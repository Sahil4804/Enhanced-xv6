  ...
  18:	4481                	li	s1,0
{
  ...
  30:	416080e7          	jalr	1046(ra) # 442 <set_priority>
                                      // #endif/
    if (pid < 0)
  ...
  40:	406080e7          	jalr	1030(ra) # 442 <set_priority>
  for (n = 0; n < NFORK; n++)
  ...
  48:	05648063          	beq	s1,s6,88 <main+0x88>
{
  ...
  56:	338080e7          	jalr	824(ra) # 38a <fork>
  5a:	892a                	mv	s2,a0
    if (pid != 0)
  ...
  78:	85c50513          	addi	a0,a0,-1956 # 8d0 <malloc+0xf0>
  ...
  a0:	85450513          	addi	a0,a0,-1964 # 8f0 <malloc+0x110>
  a4:	00000097          	auipc	ra,0x0
  a8:	67e080e7          	jalr	1662(ra) # 722 <printf>
  exit(0);
  ac:	4501                	li	a0,0
  ae:	00000097          	auipc	ra,0x0
  b2:	2e4080e7          	jalr	740(ra) # 392 <exit>
        sleep(200); // IO bound processes
  b6:	0c800513          	li	a0,200
  ba:	00000097          	auipc	ra,0x0
  be:	368080e7          	jalr	872(ra) # 422 <sleep>
      printf("Process %d finished\n", n);
  c2:	85a6                	mv	a1,s1
  c4:	00001517          	auipc	a0,0x1
  c8:	81450513          	addi	a0,a0,-2028 # 8d8 <malloc+0xf8>
  cc:	00000097          	auipc	ra,0x0
  d0:	656080e7          	jalr	1622(ra) # 722 <printf>
      exit(0);
  d4:	4501                	li	a0,0
  d6:	00000097          	auipc	ra,0x0
  da:	2bc080e7          	jalr	700(ra) # 392 <exit>
  for (; n > 0; n--)
...
strcpy(char *s, const char *t)
{
 ...
 134:	fee78fa3          	sb	a4,-1(a5) # ffffffff7fffffff <base+0xffffffff7fffefef>
