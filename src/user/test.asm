...
execout(char *s)
{
  ...
  18:	348080e7          	jalr	840(ra) # 35c <fork>
  1c:	84aa                	mv	s1,a0
    if(pid < 0){
  1e:	02054063          	bltz	a0,3e <execout+0x3e>
      printf("fork failed\n");
      exit(1);
    } else if(pid == 0){
  22:	c91d                	beqz	a0,58 <execout+0x58>
      close(1);
      char *args[] = { "echo", "x", 0 };
      exec("echo", args);
      exit(0);
  ...
  2a:	346080e7          	jalr	838(ra) # 36c <wait>
  for(int avail = 0; avail < 15; avail++){
  2e:	2905                	addiw	s2,s2,1
  30:	ff3912e3          	bne	s2,s3,14 <execout+0x14>
    }
  }
  ...
  3a:	32e080e7          	jalr	814(ra) # 364 <exit>
      printf("fork failed\n");
  3e:	00001517          	auipc	a0,0x1
  42:	86250513          	addi	a0,a0,-1950 # 8a0 <malloc+0xee>
  46:	00000097          	auipc	ra,0x0
  4a:	6ae080e7          	jalr	1710(ra) # 6f4 <printf>
      exit(1);
  4e:	4505                	li	a0,1
  50:	00000097          	auipc	ra,0x0
  54:	314080e7          	jalr	788(ra) # 364 <exit>
  ...
  62:	38e080e7          	jalr	910(ra) # 3ec <sbrk>
          if (a == 0xffffffffffffffffLL)
  66:	01350763          	beq	a0,s3,74 <execout+0x74>
          *(char *)(a + 4096 - 1) = 1;
  6a:	6785                	lui	a5,0x1
  6c:	953e                	add	a0,a0,a5
  6e:	ff450fa3          	sb	s4,-1(a0) # fff <digits+0x72f>
      {
  72:	b7ed                	j	5c <execout+0x5c>
      for(int i = 0; i < avail; i++)
  74:	01205a63          	blez	s2,88 <execout+0x88>
        sbrk(-4096);
  78:	757d                	lui	a0,0xfffff
  7a:	00000097          	auipc	ra,0x0
  7e:	372080e7          	jalr	882(ra) # 3ec <sbrk>
      for(int i = 0; i < avail; i++)
  82:	2485                	addiw	s1,s1,1
  84:	ff249ae3          	bne	s1,s2,78 <execout+0x78>
      close(1);
  88:	4505                	li	a0,1
  8a:	00000097          	auipc	ra,0x0
  8e:	302080e7          	jalr	770(ra) # 38c <close>
      char *args[] = { "echo", "x", 0 };
  92:	00001517          	auipc	a0,0x1
  96:	81e50513          	addi	a0,a0,-2018 # 8b0 <malloc+0xfe>
  9a:	faa43c23          	sd	a0,-72(s0)
  9e:	00001797          	auipc	a5,0x1
  a2:	81a78793          	addi	a5,a5,-2022 # 8b8 <malloc+0x106>
  a6:	fcf43023          	sd	a5,-64(s0)
  aa:	fc043423          	sd	zero,-56(s0)
      exec("echo", args);
  ae:	fb840593          	addi	a1,s0,-72
  b2:	00000097          	auipc	ra,0x0
  b6:	2ea080e7          	jalr	746(ra) # 39c <exec>
      exit(0);
  ba:	4501                	li	a0,0
  bc:	00000097          	auipc	ra,0x0
  c0:	2a8080e7          	jalr	680(ra) # 364 <exit>
...
main(int argc, char *argv[])
{
  ...
  d0:	7f450513          	addi	a0,a0,2036 # 8c0 <malloc+0x10e>
  d4:	00000097          	auipc	ra,0x0
  d8:	f2c080e7          	jalr	-212(ra) # 0 <execout>
...
_main()
{
  ...
  e8:	fe0080e7          	jalr	-32(ra) # c4 <main>
  exit(0);
  ec:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 464:	47050513          	addi	a0,a0,1136 # 8d0 <digits>
 468:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 530:	3a4b8b93          	addi	s7,s7,932 # 8d0 <digits>
 ...
 670:	25c90913          	addi	s2,s2,604 # 8c8 <malloc+0x116>
        while(*s != 0){
